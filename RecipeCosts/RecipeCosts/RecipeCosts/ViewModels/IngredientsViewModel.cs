...
namespace RecipeCosts.ViewModels
{
    public class IngredientsViewModel : BaseViewModel
    {
        ...
        {
            await Shell.Current.GoToAsync($"{nameof(IngredientDetailPage)}?{nameof(IngredientDetailViewModel.IngredientId)}={null}");
        }
        ...
        public async void OnEditItem()
        {
            ...
            await Shell.Current.GoToAsync($"{nameof(IngredientDetailPage)}?{nameof(IngredientDetailViewModel.IngredientId)}={SelectedIngredient.Id}");
        }
